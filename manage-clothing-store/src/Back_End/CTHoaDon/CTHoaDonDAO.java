...
public class CTHoaDonDAO implements DAOInterface<CTHoaDon> {
    ...
    public ArrayList<CTHoaDon> getData(String maPN) {
        ...
        try {
            ...
            while (rs.next()) {
                String PNID = rs.getString("CTHD_MAHD");
                String maSP = rs.getString("CTHD_MASP");
                Float donGia = rs.getFloat("DONGIA");
                int soLuong = rs.getInt("CTHD_SOLUONG");

                CTHoaDon pn = new CTHoaDon(PNID, maSP, donGia, soLuong);
                dscthd.add(pn);
            }
    ...
    public ArrayList<SANPHAM> getProducts(String maPN) {
        ...
        ArrayList <CTHoaDon> dsctpn = getData(maPN);
        for(CTHoaDon ctpn : dsctpn) {
