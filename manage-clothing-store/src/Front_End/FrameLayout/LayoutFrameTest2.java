...
//        lblThuongHieu.addMouseListener(new EventInLabel(pnMainContent, pnThuongHieu, trangThai, width, height));
//        lblHoaDon.addMouseListener(new EventInLabel(pnMainContent, pnHoaDon, trangThai, width, height));
//        lblPhieuNhap.addMouseListener(new EventInLabel(pnMainContent, pnPhieuNhap, trangThai, width, height));
//        lblKhachHang.addMouseListener(new EventInLabel(pnMainContent, pnKhachHang, trangThai, width, height));
//        lblNhanVien.addMouseListener(new EventInLabel(pnMainContent, pnNhanVien, trangThai, width, height));
//        lblNhaCungCap.addMouseListener(new EventInLabel(pnMainContent, pnNhaCungCap, trangThai, width, height));
//        lblTaiKhoan.addMouseListener(new EventInLabel(pnMainContent, pnTaiKhoan, trangThai, width, height));
//        lblKhuyenMai.addMouseListener(new EventInLabel(pnMainContent, pnPhanQuyen, trangThai, width, height));
//        lblThongKe.addMouseListener(new EventInLabel(pnMainContent, new ThongKe(840), trangThai, width, height));
//        lblLogo.addMouseListener(new EventInLabel(pnMainContent, pnKhuyenMai, trangThai, width, height));
    }
...
//        this.setUndecorated(true);
    ...
    private void initComponents() {
        ...
        pnContainer.setPreferredSize(new java.awt.Dimension(1010, 496));

        pnHeader.setBackground(new java.awt.Color(0, 0, 0));
        pnHeader.setPreferredSize(new java.awt.Dimension(184, 55));
        ...
        pnMenuLayout.setHorizontalGroup(
            ...
            .addComponent(sbMenu, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
        );
        ...
        pnMainContent.setPreferredSize(new java.awt.Dimension(840, 444));
